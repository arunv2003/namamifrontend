  ...
  return (
    ...
    >
      <Box className="flex flex-col h-full">
        ...
        <Box
          className={`flex items-center justify-between px-4 py-3 border-b sticky top-0 z-10 ${isDark ? "border-slate-800 bg-slate-900" : "border-slate-100 bg-white"
            }`}
        >
          <Box
          ...
          {columns.map((col) => {
            ...
            return (
              <Box
                ...
                className={`flex items-center gap-3 px-3 py-2 rounded-xl cursor-pointer border transition-colors duration-150 ${isChecked
                    ? isDark
